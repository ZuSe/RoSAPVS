sap.ui.controller("zy_ss14_t01_rosapvs.Landing", {
	...
	var modCM = new sap.ui.model.odata.ODataModel(
		"proxy/http/i67lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/ZY_SS14_T01_ODATA_SRV/", true, "ABAP-12", "p4ssw0rd");
    ...
    signIn : function(myUser, myPassword) {
	 ...
	 requestUri: "proxy/http/i67lp1.informatik.tu-muenchen.de:8000/sap/opu/odata/sap/ZY_SS14_T01_ODATA_SRV/UserCheckLoginCollection(User='"+myUser+"',Password='"+myPassword+"')",
	 method: "GET",
	 User: "ABAP-12",
	 Password: "p4ssw0rd",
	 }; 
    ...
    {
	sap.ui.getCore().getModel().read("/PrivilegeCollection(SapUser='"+username+"')",0,0,false,
		function (success)
		{
