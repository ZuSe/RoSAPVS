sap.ui.jsview("zy_ss14_t01_rosapvs.Platforms", {
  ...
  createContent: function(oController) {
    ...
    matLayout.createRow(new sap.ui.commons.Label({
      text: "ID"
    }), new sap.ui.commons.TextField("tF_PlatformsId", {
      editable: false
    }));
    matLayout.createRow(new sap.ui.commons.Label({
      text: "Name"
    }), new sap.ui.commons.TextField("tF_PlatformsName", {
      editable: false
    }));
    matLayout.createRow(new sap.ui.commons.Label({
      text: "Required CPU (Cores)"
    }), new sap.ui.commons.TextField("tF_PlatformsReqCPU", {
      editable: false,
      change : function(){
    ...
    }), new sap.ui.commons.TextField("tF_PlatformsReqRAM", {
      editable: false,
      change : function(){
    ...
    }), new sap.ui.commons.TextField("tF_PlatformsReqHDD", {
      editable: false,
      change : function(){
    ...
    matLayout.createRow(new sap.ui.commons.Label({
      ...
      content: [new sap.ui.commons.TextField("tF_PlatformsHost", {
        editable: false
    ...
    matLayout.createRow(new sap.ui.commons.Label({
      ...
      content: [new sap.ui.commons.TextField("tF_PlatformsPerson", {
        editable: false
    ...
    sap.ui.getCore().byId('dB_PlatformsHost').bindItems(
            "/RestrictedHostCollection", templatePlatformHost);
    ...
    sap.ui.getCore().byId('dB_PlatformsPerson').bindItems(
            "/PrivilegeCollection", templatePlatformPerson);
    ...
    layoutPlatforms.createRow(tblPlatforms, null,
            new sap.ui.commons.layout.MatrixLayoutCell({
